...
class SearchRepositoryImpl implements SearchRepository {
  ...
  @override
  Future<Either<Exception, List<ResultSearch>>> search(
      String searchText) async {
    try {
      final result = await datasource.getSearch(searchText);
      return Right(result);
    } on DatasourceError catch (e) {
      return Left(e); // se o erro for personalizado
    } catch (e) {

      // posso fazer testes de erro, tanto de status code quanto de se ele vier vazio, por ex
